...
/* Ventas descendenes.
El programa, al recibir como datos tres valores que representan las ventasde los vendedores de una tienda de discos, escibe las ventas en orden descenddente.
